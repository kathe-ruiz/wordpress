<?php
class InfoHeaderWidget extends WP_Widget {
  ...
  public function widget( $args, $instance ) {
    ...
    ob_start();
    get_template_part('widgets/pre-header-info/frontend');
...
function register_info_header_widget() {
  register_widget( 'InfoHeaderWidget' );
}
add_action( 'widgets_init', 'register_info_header_widget' );