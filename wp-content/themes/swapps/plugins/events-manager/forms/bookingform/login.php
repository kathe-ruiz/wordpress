...
<div class="em-booking-login">
	...
	<input class="btn btn-primary-withoutborder" type="submit" name="wp-submit" id="em_wp-submit" value="<?php esc_html_e('Log In', 'events-manager'); ?>" tabindex="100" /><br><br>
	<input name="rememberme" type="checkbox" id="em_rememberme" value="forever" /> <label style="vertical-align: middle; width: auto;"><?php esc_html_e( 'Remember Me','events-manager') ?></label>
