<footer class="footer navbar-inverse">
  <div class="container-fluid">
    <div class="row">
      ...
      <div class="footer__logo col-sm-2 col-lg-1">
        <img class="footer__logo__img" src="<?php echo get_template_directory_uri(); ?>/assets/images/logo.png" alt="Footer logo">
      </div>
      <div class="footer__info col-sm-3 col-lg-2">
        <p>Carrera 100 # 5 - 169,<br>Cali, Colombia</p>
        <a href="#">info@misitioweb.com</a>
      </div>
      <div class="col-sm-6 col-sm-offset-1 col-lg-offset-3">
        <div class="row">
          ...
          <div class="footer__copyright col-sm-12 text-right">
            <p>&copy; 2017 misitioweb. Todos los derechos reservados</p>
          </div>
        </div>
      </div>
    </div>
