...
<article id="post-<?php the_ID(); ?>" <?php post_class( 'flexible-opp' ); ?>>
	...
	<header class="entry-header heading-underline">
		<?php the_title( sprintf( '<h2 class="entry-title heading-underline__title"><a href="%s" rel="bookmark">', esc_url( get_permalink() ) ), '</a></h2>' ); ?>
	</header><!-- .entry-header -->
