...
<div class="acadp acadp-user acadp-post-form">
	<form action="<?php echo acadp_get_listing_form_page_link(); ?>" method="post" id="acadp-post-form" class="form-vertical" role="form">
        ...
        <!-- Listing details -->
        <div id="acadp-listing-details" class="panel panel-default">
        ...
        <?php if( $can_add_images ) : ?>
        	...
        	<div class="panel panel-default">
            	...
            	<div class="panel-body">
                	<?php if( $general_settings['maximum_images_per_listing'] > 0 ) : ?>
                    	<p class="help-block">
                        	<strong><?php _e( 'Note', 'advanced-classifieds-and-directory-pro' ); ?></strong>: 
							<?php printf( __( 'You can upload upto %d images', 'advanced-classifieds-and-directory-pro' ), $general_settings['maximum_images_per_listing'] ); ?>
                        </p>
                    <?php endif; ?>
                		...
                		<tbody>
                    		<?php
    							...
    							if( isset( $post_meta['images'] ) ) {
									...
									if( $general_settings['maximum_images_per_listing'] > 0 && count( $images ) >= $general_settings['maximum_images_per_listing'] ) {
                	...
                	<a href="javascript:void(0);" class="btn btn-default" id="acadp-upload-image"<?php $disable_image_upload_attr; ?>><?php _e( 'Upload Image', 'advanced-classifieds-and-directory-pro' ); ?></a>
            	</div>
        	</div>
        <?php endif; ?>        
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <?php if( $has_draft ) : ?>
                	<input type="submit" name="action" class="btn btn-default" value="<?php _e( 'Save Draft', 'advanced-classifieds-and-directory-pro' ); ?>" />
                <?php endif; ?>
                ...
                <?php if( $has_draft ) { ?>
                	<input type="submit" name="action" class="btn btn-primary pull-right" value="<?php _e( 'Place Listing', 'advanced-classifieds-and-directory-pro' ); ?>" />
                <?php } else { ?>
                	<input type="submit" name="action" class="btn btn-primary pull-right" value="<?php _e( 'Save Changes', 'advanced-classifieds-and-directory-pro' ); ?>" />
                <?php } ?>
    ...
    <form id="acadp-form-upload" class="hidden" method="post" action="#" enctype="multipart/form-data">
  		<input type="file" name="acadp_image" id="acadp-upload-image-hidden" />
