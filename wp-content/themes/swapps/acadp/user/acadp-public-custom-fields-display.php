				...
				switch( $field_meta['type'][0] ) {
					...
					case 'checkbox' :
						...
						foreach( $choices as $choice ) {
							...
							printf( '<label class="btn btn-default"><input type="checkbox" name="acadp_fields[%d][]" value="%s"%s>%s</label>', $post->ID, $_value, $_attr, $_label );
						}
						echo "</div>";
						break;
					case 'radio' :
						...
						foreach( $choices as $choice ) {
							...
							printf( '<label class="btn btn-default"><input type="radio" name="acadp_fields[%d]" value="%s"%s>%s</label>', $post->ID, $_value, $_attr, $_label );
						}
						echo "</div>";
						break;
					case 'url'  :			
